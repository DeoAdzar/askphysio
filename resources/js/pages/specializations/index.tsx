...
// Dummy images array - menggunakan picsum dengan seed yang konsisten
const dummyImages = [
    'https://picsum.photos/seed/neuro/200/200',
    'https://picsum.photos/seed/sport/200/200',
    'https://picsum.photos/seed/pediatri/200/200',
    'https://picsum.photos/seed/geriatri/200/200',
    'https://picsum.photos/seed/disabilitas/200/200',
    'https://picsum.photos/seed/muskuloskeletal/200/200',
    'https://picsum.photos/seed/kardio/200/200',
    'https://picsum.photos/seed/wanita/200/200',
    'https://picsum.photos/seed/integumen/200/200',
];

export default function SpecializationsIndex({ specializations }: Props) {
    return (
        <>
            <Head title="Cari Fisioterapi - askPhysio" />

            <div className="min-h-screen bg-[#f8fafc] text-[#0b1b4a]">
                {/* Header - sama seperti welcome.tsx */}
                    ...
                    <div className="grid grid-cols-3 gap-4 pb-8">
                        {specializations.map((specialization, index) => (
                            <Link
                                ...
                                href={`/physiotherapy/specialization/${specialization.id}`}
                                className="flex flex-col items-center text-center group"
                            >
                                <div className="w-full aspect-square rounded-full bg-[#dbe9ff] overflow-hidden mb-2 shadow-md group-hover:shadow-lg transition-shadow">
                                    <img
                                        src={specialization.image || dummyImages[index % dummyImages.length]}
                                        alt={specialization.name}
                                        className="w-full h-full object-cover"
                                    />
                                </div>
                                <h3 className="text-xs font-medium text-[#10207A] leading-tight px-1">
                                    {specialization.name}
                                </h3>
                            </Link>
                        ))}
